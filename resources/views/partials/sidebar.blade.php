    ...
    <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="{{ route('penalties.index') }}" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="{{ route('fonts') }}" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="{{ route('icons') }}" aria-expanded="false">
