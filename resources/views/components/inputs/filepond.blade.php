<div
    ...
    x-init="() => {
        ...
        labelIdle: '<span class=fw-bold>Arrastrar y suelta archivos o<br><span class=text-decoration-underline>Busca en un directorio.</span></span>',
                labelFileTypeNotAllowed: 'Archivo de tipo inválido',
        });
        post.setOptions({
            files: {!! $attributes->has('files') ? $attributes->get('files') : '[]' !!},
