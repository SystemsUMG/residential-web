...
class TicketCategoryPolicy
{
    ...
    {
        return $user->hasPermissionTo('view ticket categories');
    }
    ...
    {
        return $user->hasPermissionTo('create ticket categories');
    }
    ...
    {
        return $user->hasPermissionTo('edit ticket categories');
    }
    ...
    {
        return $user->hasPermissionTo('delete ticket categories');
    }
